  ...
  items: [
    {
      ...
      title: "25+",
      accent: "years",
      body: "of HVAC excellence across South India",
    },
    {
      id: "cities",
      variant: "stat",
      ...
      title: "8",
      accent: "cities",
      body: "served with local teams and shared standards",
    },
    {
      id: "engineers",
      variant: "stat",
    ...
    },
    {
      ...
      body: "One partner connecting site survey, AutoCAD layouts, install, commissioning, and AMC.",
    ...
    },
    {
      ...
      area: "gaps",
      title: "No more",
      strikes: ["vendor juggling", "guesswork sizing", "reactive repairs"],
    },
    {
      id: "scope",
      variant: "media",
      from: "bottom-right",
      area: "scope",
      title: "Commercial to home",
      body: "Precision cooling for every scale of space",
      image: "/images/home/fullscreen-01.webp",
    },
  ],
} as const;
