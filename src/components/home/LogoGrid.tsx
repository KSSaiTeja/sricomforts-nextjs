...
import { logoGridLogos, type LogoWallItem } from "@/data/homepage";
...
function buildLogoSlots(logos: LogoWallItem[], isDesktop: boolean) {
...
export function LogoGrid() {
  ...
  const slots = useMemo(
    () => buildLogoSlots(logoGridLogos, isDesktop),
    [isDesktop],
  );
  ...
  return (
    <section ref={sectionRef} className="logo-grid-wrapper logo-grid-industry">
