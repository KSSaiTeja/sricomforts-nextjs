...
> **Superseded.** Active hero direction is hybrid white/blue *Cool Air Architecture* via Higgsfield — see [`docs/hero-hybrid-higgsfield-prompts.md`](hero-hybrid-higgsfield-prompts.md). Kept below for archive only.
